...
export default async function handler(req, res) {
  ...
  const approveLink = `${process.env.BASE_URL}/api/booking-response?id=${data.id}&action=approve`;
  const denyLink = `${process.env.BASE_URL}/api/booking-response?id=${data.id}&action=deny`;
